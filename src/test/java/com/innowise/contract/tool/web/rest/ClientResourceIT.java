...
class ClientResourceIT {
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getLegalAddress()).isEqualTo(DEFAULT_LEGAL_ADDRESS);
        ...
        assertThat(testClient.getBankAddress()).isEqualTo(DEFAULT_BANK_ADDRESS);
    ...
    void getAllClients() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].legalAddress")
            .value(hasItem(DEFAULT_LEGAL_ADDRESS))
            ...
            .jsonPath("$.[*].bankAddress")
            .value(hasItem(DEFAULT_BANK_ADDRESS))
            .jsonPath("$.[*].swiftCode")
    ...
    void getClient() {
        ...
        webTestClient
            ...
            .jsonPath("$.legalAddress")
            .value(is(DEFAULT_LEGAL_ADDRESS))
            .jsonPath("$.registrationNumber")
    ...
    void putNewClient() throws Exception {
        ...
        assertThat(testClient.getLegalAddress()).isEqualTo(UPDATED_LEGAL_ADDRESS);
        ...
        assertThat(testClient.getBankAddress()).isEqualTo(UPDATED_BANK_ADDRESS);
