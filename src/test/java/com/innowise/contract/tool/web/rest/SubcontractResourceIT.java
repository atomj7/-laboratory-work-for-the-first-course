...
class SubcontractResourceIT {
    ...
    void createSubcontract() throws Exception {
        ...
        assertThat(testSubcontract.getDomainId()).isEqualTo(DEFAULT_DOMAIN_ID);
    ...
    @Test
    void checkDomainIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = subcontractRepository.findAll().collectList().block().size();
        // set the field null
        subcontract.setDomainId(null);
    ...
    void getAllSubcontracts() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].domainId")
            .value(hasItem(DEFAULT_DOMAIN_ID))
            .jsonPath("$.[*].link")
    ...
    void putNewSubcontract() throws Exception {
        ...
        assertThat(testSubcontract.getDomainId()).isEqualTo(UPDATED_DOMAIN_ID);
