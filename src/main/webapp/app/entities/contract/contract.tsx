  ...
  return (
    <div>
      <h2 id="contract-heading" data-cy="ContractHeading">
        <Translate contentKey="contractTooolApp.contract.home.title">Contracts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="contractTooolApp.contract.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/contract/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="contractTooolApp.contract.home.createLabel">Create new Contract</Translate>
          </Link>
        </div>
      </h2>
        ...
        {contractList && contractList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="contractTooolApp.contract.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('cipher')}>
                  <Translate contentKey="contractTooolApp.contract.cipher">Cipher</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('providerId')}>
                  <Translate contentKey="contractTooolApp.contract.providerId">Provider Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('typeId')}>
                  <Translate contentKey="contractTooolApp.contract.typeId">Type Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('sum')}>
                  <Translate contentKey="contractTooolApp.contract.sum">Sum</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('positionCount')}>
                  <Translate contentKey="contractTooolApp.contract.positionCount">Position Count</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('currencyId')}>
                  <Translate contentKey="contractTooolApp.contract.currencyId">Currency Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('paymentTerm')}>
                  <Translate contentKey="contractTooolApp.contract.paymentTerm">Payment Term</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('startDate')}>
                  <Translate contentKey="contractTooolApp.contract.startDate">Start Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('finishDate')}>
                  <Translate contentKey="contractTooolApp.contract.finishDate">Finish Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('statusId')}>
                  <Translate contentKey="contractTooolApp.contract.statusId">Status Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('link')}>
                  <Translate contentKey="contractTooolApp.contract.link">Link</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="contractTooolApp.contract.client">Client</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {contractList.map((contract, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{contract.link}</td>
                  <td>
                    <Translate contentKey={`contractTooolApp.LifecycleStatus.${contract.lifecycleStatus}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="contractTooolApp.contract.home.notFound">No Contracts found</Translate>
            </div>
          )
        )}
      </div>
