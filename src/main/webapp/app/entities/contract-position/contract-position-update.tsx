  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="contractTooolApp.contractPosition.home.createOrEditLabel" data-cy="ContractPositionCreateUpdateHeading">
            <Translate contentKey="contractTooolApp.contractPosition.home.createOrEditLabel">Create or edit a ContractPosition</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  label={translate('contractTooolApp.contractPosition.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('contractTooolApp.contractPosition.contractPositionId')}
              ...
              <ValidatedField
                label={translate('contractTooolApp.contractPosition.employeeId')}
              ...
              <ValidatedField
                label={translate('contractTooolApp.contractPosition.numberContractPosition')}
              ...
              <ValidatedField
                label={translate('contractTooolApp.contractPosition.restrictionTypeId')}
              ...
              <ValidatedField
                label={translate('contractTooolApp.contractPosition.restriction')}
              ...
              <ValidatedField
                label={translate('contractTooolApp.contractPosition.currencyId')}
              ...
              <ValidatedField
                label={translate('contractTooolApp.contractPosition.rateAnHour')}
              ...
              <ValidatedField
                label={translate('contractTooolApp.contractPosition.statusId')}
              ...
              <ValidatedField
                label={translate('contractTooolApp.contractPosition.lifecycleStatus')}
              ...
              <ValidatedField
                ...
                name="subcontract"
                data-cy="subcontract"
                label={translate('contractTooolApp.contractPosition.subcontract')}
                type="select"
              >
                <option value="" key="0" />
                {subcontracts
