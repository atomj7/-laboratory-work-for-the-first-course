  ...
  return (
    <div>
      <h2 id="contract-position-heading" data-cy="ContractPositionHeading">
        <Translate contentKey="contractTooolApp.contractPosition.home.title">Contract Positions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="contractTooolApp.contractPosition.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/contract-position/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="contractTooolApp.contractPosition.home.createLabel">Create new Contract Position</Translate>
          </Link>
        </div>
      </h2>
        ...
        {contractPositionList && contractPositionList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="contractTooolApp.contractPosition.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('statusId')}>
                  <Translate contentKey="contractTooolApp.contractPosition.statusId">Status Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {contractPositionList.map((contractPosition, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`contractTooolApp.LifecycleStatus.${contractPosition.lifecycleStatus}`} />
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="contractTooolApp.contractPosition.home.notFound">No Contract Positions found</Translate>
            </div>
          )
        )}
      </div>
