...
export const SubcontractDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="contractTooolApp.subcontract.delete.question">
        <Translate contentKey="contractTooolApp.subcontract.delete.question" interpolate={{ id: subcontractEntity.id }}>
