  ...
  return (
    <div>
      <h2 id="subcontract-heading" data-cy="SubcontractHeading">
        <Translate contentKey="contractTooolApp.subcontract.home.title">Subcontracts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="contractTooolApp.subcontract.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/subcontract/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="contractTooolApp.subcontract.home.createLabel">Create new Subcontract</Translate>
          </Link>
        </div>
      </h2>
        ...
        {subcontractList && subcontractList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="contractTooolApp.subcontract.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('statusId')}>
                  <Translate contentKey="contractTooolApp.subcontract.statusId">Status Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('sum')}>
                  <Translate contentKey="contractTooolApp.subcontract.sum">Sum</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('positions')}>
                  <Translate contentKey="contractTooolApp.subcontract.positions">Positions</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('currencyId')}>
                  <Translate contentKey="contractTooolApp.subcontract.currencyId">Currency Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('startDate')}>
                  <Translate contentKey="contractTooolApp.subcontract.startDate">Start Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('finishDate')}>
                  <Translate contentKey="contractTooolApp.subcontract.finishDate">Finish Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('typeId')}>
                  <Translate contentKey="contractTooolApp.subcontract.typeId">Type Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('tasktTypeId')}>
                  <Translate contentKey="contractTooolApp.subcontract.tasktTypeId">Taskt Type Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('domainId')}>
                  <Translate contentKey="contractTooolApp.subcontract.domainId">Domain Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('link')}>
                  <Translate contentKey="contractTooolApp.subcontract.link">Link</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="contractTooolApp.subcontract.contract">Contract</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="contractTooolApp.subcontract.project">Project</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {subcontractList.map((subcontract, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{subcontract.domainId}</td>
                  <td>{subcontract.link}</td>
                  <td>
                    <Translate contentKey={`contractTooolApp.LifecycleStatus.${subcontract.lifecycleStatus}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="contractTooolApp.subcontract.home.notFound">No Subcontracts found</Translate>
            </div>
          )
        )}
      </div>
