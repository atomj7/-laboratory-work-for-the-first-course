...
public class ClientRowMapper implements BiFunction<Row, String, Client> {
    ...
    public Client apply(Row row, String prefix) {
        ...
        entity.setLegalAddress(converter.fromRow(row, prefix + "_legal_address", String.class));
        ...
        entity.setBankAddress(converter.fromRow(row, prefix + "_bank_address", String.class));
